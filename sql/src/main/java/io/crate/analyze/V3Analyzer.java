...
public class V3Analyzer implements Analyzer {
    ...
    @Inject
    public V3Analyzer(AnalyzerDispatcher dispatcher) {
    ...
    public Analysis analyze(String statement, ParameterContext parameterContext) throws Exception {
        return analyze(statementCache.get(statement), parameterContext);
    }
